...
const (
	...
	BookService_GetBookRecommendations_FullMethodName = "/book.BookService/GetBookRecommendations"
)
...
type BookServiceClient interface {
	...
	GetBookRecommendations(ctx context.Context, in *GetBookRecommendationsRequest, opts ...grpc.CallOption) (*GetBookRecommendationsResponse, error)
}
...
func (c *bookServiceClient) GetBookRecommendations(ctx context.Context, in *GetBookRecommendationsRequest, opts ...grpc.CallOption) (*GetBookRecommendationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookRecommendationsResponse)
	err := c.cc.Invoke(ctx, BookService_GetBookRecommendations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	GetBookRecommendations(context.Context, *GetBookRecommendationsRequest) (*GetBookRecommendationsResponse, error)
...
func (UnimplementedBookServiceServer) GetBookRecommendations(context.Context, *GetBookRecommendationsRequest) (*GetBookRecommendationsResponse, error) {
...
func _BookService_GetBookRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookRecommendationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).GetBookRecommendations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_GetBookRecommendations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetBookRecommendations(ctx, req.(*GetBookRecommendationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookService_GetBookRecommendations_Handler,
		},
	},
