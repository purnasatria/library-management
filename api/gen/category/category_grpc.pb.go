...
func (c *categoryServiceClient) UpdateItemCategories(ctx context.Context, in *UpdateItemCategoriesRequest, opts ...grpc.CallOption) (*UpdateItemCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateItemCategoriesResponse)
	err := c.cc.Invoke(ctx, CategoryService_UpdateItemCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) BulkAddItemToCategories(ctx context.Context, in *BulkAddItemToCategoriesRequest, opts ...grpc.CallOption) (*BulkAddItemToCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BulkAddItemToCategoriesResponse)
	err := c.cc.Invoke(ctx, CategoryService_BulkAddItemToCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) GetItemCategories(ctx context.Context, in *GetItemCategoriesRequest, opts ...grpc.CallOption) (*GetItemCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetItemCategoriesResponse)
	err := c.cc.Invoke(ctx, CategoryService_GetItemCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCategoryServiceServer) UpdateItemCategories(context.Context, *UpdateItemCategoriesRequest) (*UpdateItemCategoriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateItemCategories not implemented")
}
func (UnimplementedCategoryServiceServer) BulkAddItemToCategories(context.Context, *BulkAddItemToCategoriesRequest) (*BulkAddItemToCategoriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BulkAddItemToCategories not implemented")
}
...
func _CategoryService_UpdateItemCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateItemCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).UpdateItemCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_UpdateItemCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).UpdateItemCategories(ctx, req.(*UpdateItemCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CategoryService_BulkAddItemToCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkAddItemToCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).BulkAddItemToCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_BulkAddItemToCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).BulkAddItemToCategories(ctx, req.(*BulkAddItemToCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CategoryService_GetItemCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetItemCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).GetItemCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_GetItemCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetItemCategories(ctx, req.(*GetItemCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateItemCategories",
			Handler:    _CategoryService_UpdateItemCategories_Handler,
		},
		{
			MethodName: "BulkAddItemToCategories",
			Handler:    _CategoryService_BulkAddItemToCategories_Handler,
		},
		{
